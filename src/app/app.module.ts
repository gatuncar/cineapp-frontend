...
@NgModule({
  ...
  entryComponents: [
    GeneroDialogoComponent, PerfilComponent, ComidaDialogoComponent, ConsultaDialogoComponent, ConfiguracionDialogoComponent, ClienteDialogoComponent, NuevoClienteComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
    ...
    JwtModule.forRoot({
      config: {
        ...
        whitelistedDomains: ['localhost:8091'], //['165.227.89.201'], //['localhost:8080'],
        blacklistedRoutes: ['http://localhost:8091/oauth/token']//['http://165.227.89.201/oauth/token'] //['http://localhost:8080/oauth/token']
      }
    })
  ],
  providers: [
